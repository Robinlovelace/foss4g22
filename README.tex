...
To overcome these limitations we developed a `jittering' approach to conversion of OD datasets to desire lines that randomly samples points within each zone (Lovelace, Félix, and Carlino 2022).
