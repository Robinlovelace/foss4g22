...
Results were then assessed. Count data was compared with the resulting route networks (with information on bike trips at each segment level, from the mobility survey data), using a R^2^ correlation fit.
...
We have used the approach to add value to numerous OD datasets for projects based in Ireland, Norway, Portugal, New Zealand and beyond, and in this particular case study, we can validate the used of this method, which brings better fit results than the traditional centroid-zone desire line.
