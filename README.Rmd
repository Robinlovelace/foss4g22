...
library(biclar)
tmap_mode("view")
pal = cols4all::c4a(palette = "mako", n = length(breaks) - 1)
...
results = tibble::tribble(
  ...
  "Jittered, 500 disaggregation", "LTS2", nrow(od_lisbon_jittered_500_r5r), cor(counters_sf_joined$SumCiclistas, counters_sf_joined$Bikes_jittered_500_lts2),
  "Jittered, 500 disaggregation", "LTS4", nrow(od_lisbon_jittered_500_r5r), cor(counters_sf_joined$SumCiclistas, counters_sf_joined$Bikes_jittered_500_lts4),
  )
