...
To overcome these limitations we developed a 'jittering' approach to conversion of OD datasets to desire lines that randomly samples points within each zone [@lovelace_jittering_2022b].
...
- Estimates of cycling potential, generated using the jittering -> routing -> route network methods presented in this paper.
