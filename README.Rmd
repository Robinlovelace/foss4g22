...
Figure \@ref(fig:map1) shows and example of route network from unjittered OD pairs, and jittered OD pairs with disagregation level of 500 trips, for routing option "quietest", and the counters.


```{r map1, echo=FALSE, message=FALSE, warning=FALSE, fig.ncol=2, out.width="100%"}
library(tmap)
library(biclar)
# tmap_mode("view")
